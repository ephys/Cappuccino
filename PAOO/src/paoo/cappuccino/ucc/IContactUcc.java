...
public interface IContactUcc {
   ...
   * @param company The id of the company the contact is working for.If equal to 0 then no change
   *        will be done.
   * @param email The contact's mail, nullable.
   * @param firstName The contact's first name, nullable.
   * @param lastName The contact's last name, nullable.
   * @param phone The contact's phone number, nullable.
   * @return The new contact's DTO.
