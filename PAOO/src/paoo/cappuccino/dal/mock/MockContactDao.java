...
class MockContactDao implements IContactDao {
  ...
  public MockContactDao(IEntityFactory factory) {
    ...
    createContact(factory.createContact(3, "AlfredChandleur@gmail.com", "Chandleur", "Alfred",
        "02/237.42.79"));
    createContact(factory.createContact(4, "Contact@gmail.com", "ContactFirstname",
