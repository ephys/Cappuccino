...
public class RegistrationView extends JPanel implements ChangeListener{
	   ...
	   */
	  public RegistrationView(RegistrationModel model, JTextField usernameField, JPasswordField passwordField,JPasswordField confirmPasswordField, 
			  JTextField lastNameField,JTextField firstNameField,JTextField emailField) {
	    super(new GridLayout(7, 1, 0, IhmConstants.M_GAP));
	    ...
	    this.confirmPasswordPanel = new ErrorableTextField(confirmPasswordField, "Confirmer mot de passe");
