...
public class RegistrationModel extends BaseModel{
	   ...
	   */
	  public boolean registrationAttempt(String username, char[] password, char[] confirmPassword, String lastName, String 
	    ...
	    lastNameError = StringUtils.isEmpty(lastName)? IhmConstants.ERROR_FIELD_EMPTY:
	    	(!StringUtils.isAlphaString(lastName)? IhmConstants.ERROR_INVALID_INPUT_STRING : "");
	    isValid += lastNameError;
	    firstNameError = StringUtils.isEmpty(firstName)? IhmConstants.ERROR_FIELD_EMPTY:
