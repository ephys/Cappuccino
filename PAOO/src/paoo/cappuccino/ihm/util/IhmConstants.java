...
public interface IhmConstants {
   ...
   */
  static final String ERROR_NOT_MATCHING_PASSWORD =
      "Les mots de passes ne correspondent pas ! ";
  /**
   * error invalid email.
   */
  static final String ERROR_INVALID_EMAIL =
      "l'email spécifié est invalide ! ";

  /**
   * error invalid input string.
   */
  static final String ERROR_INVALID_INPUT_STRING =
