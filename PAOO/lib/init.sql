...
VALUES (DEFAULT, 1, 'Accenture', '2009-01-01', 'Waterloolaan ', '16', NULL, '1000', 'Bruxelles',
        DEFAULT);
-- Participations
...
VALUES (DEFAULT, 1, 'stephanie.de.troyer@accenture.com', DEFAULT, 'Stéphanie', 'De troyer', NULL,
        DEFAULT);
INSERT INTO business_days.contacts
...
-- Contacts
INSERT INTO business_days.contacts
VALUES (DEFAULT, 2, 'Vincent.lepape@CodeItBlue.com', DEFAULT, 'Vincent', 'Lepape', '0479/97.95.05',
        DEFAULT);
-- Attendances
...
INSERT INTO business_days.companies
VALUES
  (DEFAULT, 1, 'STERIA', '2012-01-01', 'Boulevard du Souverain', '36', NULL, '1170', 'Bruxelles',
   DEFAULT);
-- Participations
...
INSERT INTO business_days.companies
VALUES (DEFAULT, 2, 'Eezee-IT', '2012-01-01', 'rue André Dumont', '5', NULL, '1435',
        'Mont-Saint-Guibert', DEFAULT);
-- Participations
...
-- Contacts
INSERT INTO business_days.contacts
VALUES (DEFAULT, 4, 'nicolas.rigo@eezee-it.com', DEFAULT, 'Nicolas', 'Rigo', '+32 478 88 02 55',
        DEFAULT);
-- Attendances
...
INSERT INTO business_days.companies
VALUES
  (DEFAULT, 2, 'Bewan', '2011-01-01', 'Drève Richelle', '161L', '46', '1410', 'Waterloo', DEFAULT);
-- Participations
